...
//
//                    "<div style='width: 45%; height: 226px; float: left; margin: 0px; margin-right: 24px;'><div class='flexslider singleslider' >\n" +
...
//"</ul>" + 
//"<div class='clearfix'></div><div id='slideshowloader'></div><ul class='flex-direction-nav'><li><a class='flex-prev' href='#'>Previous</a></li><li><a class='flex-next' href='#'>Next</a></li></ul></div>" + 
//"<div style='padding-top: 5px;'><div class='auto-services' style='float: left; padding: 5px;'>Бренды:</div><img src='http://ukrautoportal.com/wp-content/uploads/auto-brands/1.jpg' style='height: 30px'><img src='http://ukrautoportal.com/wp-content/uploads/auto-brands/2.jpg' style='height: 30px'></div>" +
//"</div>"+
//"[wpgmza id='1']\n" +
//"<div class='l-middle-left'>\n" +
//"<div class='auto-services'>О салоне</div>" +
...
//"<div class='auto-services' style='margin-top: 9px;'>Контакты</div>" +
...
//"</div>\n" +
//"<div>" +
//    "<div class='auto-services'>Услуги</div>" +
//    "<div id='auto-services-container'><img class='auto-serviceImg' src='http://ukrautoportal.com/wp-content/uploads/auto-services/credit.gif'/><div class='auto-serviceName'>Service Namesdfsdfsdf</div></div>" + 
//    "<div id='auto-services-container'><img class='auto-serviceImg' src='http://ukrautoportal.com/wp-content/uploads/auto-services/credit.gif'/><div class='auto-serviceName'>Service Namesdfsdfsdf</div></div>" +
//    "<div id='auto-services-container'><img class='auto-serviceImg' src='http://ukrautoportal.com/wp-content/uploads/auto-services/credit.gif'/><div class='auto-serviceName'>Service Namesdfsdfsdf</div></div>" +
//"</div>" +
//                    "</div>");
