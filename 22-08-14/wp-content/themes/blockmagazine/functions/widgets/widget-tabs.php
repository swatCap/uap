...
class tmnf_tabs_widget extends WP_Widget {
	...
	wp_enqueue_script('tabs', get_template_directory_uri() .'/js/tabs.js','','', true);
		...
		?>
        	...
        	<div id="hometab" style="width: 336px;" class="" >
            
                <ul id="serinfo-nav">
                
                        <li class="li01"><a href="#serpane0"><?php _e('Популярные','themnific');?></a></li>
                        <li class="li02"><a href="#serpane1"><?php _e('Последние','themnific');?></a></li>
                        <li class="li03"><a href="#serpane2"><?php _e('Чтиво','themnific');?></a></li>
