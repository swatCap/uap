...
function wpgmza_pro_return_category_checkbox_list($map_id,$show_all = true) {
    global $wpdb;
    global $wpgmza_tblname_categories;
    global $wpgmza_tblname_category_maps;
    ...
    $sql = "SELECT * FROM `$wpgmza_tblname_category_maps` WHERE `map_id` = '$map_id' OR `map_id` = '0'";
        ...
        if ($show_all) { $ret_msg .= "<input type='checkbox' class='wpgmza_checkbox' id='wpgmza_cat_checkbox' name='wpgmza_cat_checkbox' mid=\"".$map_id."\" value=\"0\" />".__("All","wp-google-maps"); }
        $ret_msg .= "</div>";
