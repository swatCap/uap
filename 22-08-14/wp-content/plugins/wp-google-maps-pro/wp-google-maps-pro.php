                    ...
                    <div style='display:block; width:49%; margin-right:1%; overflow:auto; float:left;'>
                        ...
                        <div id=\"tabs-m-1\">
                            ...
                            <tr>
                                ...
                                <td>
                                        ".wpgmza_pro_return_category_checkbox_list($_GET['map_id'],false)."
                                </td>
                            </tr>
                            <tr>
...
function wpgmaps_action_callback_pro() {
        ...
        if ($check == 1) {
            ...
            if ($_POST['action'] == "add_marker") {
                ...
                $ins_array = array( 'map_id' => $_POST['map_id'], 'title' => $_POST['title'], 'address' => $_POST['address'], 'description' => $_POST['desc'], 'pic' => $_POST['pic'], 'icon' => $_POST['icon'], 'link' => $_POST['link'], 'lat' => $_POST['lat'], 'lng' => $_POST['lng'], 'anim' => $_POST['anim'], 'category' => $cat, 'infoopen' => $_POST['infoopen'] );
    ...
    if ($short_code_active) {
        ...
        <script type="text/javascript">
            if (typeof window.google === 'object' && typeof window.google.maps === 'object') { } else {
                ...
                document.write(unescape("%3Cscript src='" + gmapsJsHost + "maps.google.com/maps/api/js?<?php echo $api_version_string; ?>sensor=false&libraries=weather&amp;language=ru-RU' type='text/javascript'%3E%3C/script%3E"));
            }
        </script>
...
function wpgmaps_admin_javascript_pro() {
    ...
    <script type="text/javascript">
        var gmapsJsHost = (("https:" == document.location.protocol) ? "https://" : "http://");
        document.write(unescape("%3Cscript src='" + gmapsJsHost + "maps.google.com/maps/api/js?<?php echo $api_version_string; ?>sensor=false&amp;language=ru-RU' type='text/javascript'%3E%3C/script%3E"));
    </script>
                    ...
                    if ( empty($data[7]) || empty($data[8]) ){
                          ...
                          if ( function_exists('curl_version') ) {
                                   // Add your GOogle API key here, or you won't receive a result from Google
                                    ...
                                    if ($decoded->status != "OK") { echo "Unable to get location data for " . $data[2] . "<br>"; continue; }
...
function wpgmaps_head_pro() {
    ...
    if (isset($_POST['wpgmza_savemap'])){
        ...
        $other_settings['store_locator_query_string'] = esc_attr($_POST['wpgmza_store_locator_query_string']);
