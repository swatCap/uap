...
function InitMap(map_id,cat_id) {
    ...
    var mlD = document.getElementById('d') ? document.getElementById('d').innerHTML : null;
    var mlE = document.getElementById('e') ? document.getElementById('e').innerHTML : null;
    var mlCustZoom = document.getElementById('cst_zoom') ? document.getElementById('cst_zoom').innerHTML : null;

    var myLatLng = new window.google.maps.LatLng(wpgmaps_localize[map_id]['map_start_lat'],wpgmaps_localize[map_id]['map_start_lng']);

    if(mlD && mlD != null && mlE && mlE != null){
	myLatLng.d = mlD;
	myLatLng.e = mlE;
    }
    ...
    var zoommm = wpgmaps_localize[map_id]['map_start_zoom'];

    if (mlCustZoom && mlCustZoom != null){
	zoommm = mlCustZoom;
    }


    MYMAP[map_id].init("#wpgmza_map_"+map_id, myLatLng, parseInt(zoommm), wpgmaps_localize[map_id]['type'],map_id);
